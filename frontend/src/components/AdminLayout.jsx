...
const AdminLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-100">
            <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-100">
              ...
              <button className="mt-3 w-full px-4 py-2 bg-white text-indigo-600 rounded-lg text-sm font-medium border border-indigo-100 hover:bg-indigo-50 transition-colors">
                Logout
              </button>
            </div>
          </div>
