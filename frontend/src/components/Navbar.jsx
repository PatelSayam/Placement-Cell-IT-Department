        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-100">
          ...
          {!isAdmin && (
            <>
              ...
              <MobileNavLink to="/applied" onClick={toggleMenu}>Applications</MobileNavLink>
          ...
          {isAdmin && (
            <>
              <MobileNavLink to="/admin/dashboard" onClick={toggleMenu}>Dashboard</MobileNavLink>
              <MobileNavLink to="/admin/students" onClick={toggleMenu}>Students</MobileNavLink>
              <MobileNavLink to="/admin/companies" onClick={toggleMenu}>Companies</MobileNavLink>
              <MobileNavLink to="/admin/applications" onClick={toggleMenu}>Applications</MobileNavLink>
              <MobileNavLink to="/admin/analytics" onClick={toggleMenu}>Analytics</MobileNavLink>
              <MobileNavLink to="/admin/settings" onClick={toggleMenu}>Settings</MobileNavLink>
            </>
          )}
        </div>
        {user && (
